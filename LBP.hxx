 ...
 *****************************/
vector<pixel<int> > const getNBList(int R, int P){
    vector<pixel<int> > nblist;
...
vector<pixel<float> > const getNBListFloat(int R, int P){
    vector<pixel<float> > nblist;
...
vector<float> LBPImage (MultiArrayView<2, UInt8> const imin,  MultiArrayView<2, UInt8> imout, int const R, int const P, bool isPadding, bool isInterplt){
    
    vector<pixel <float> > nblistF;
    vector<pixel <int> > nblistI;
    ...
    vector<float> histogram(n_val, 0.0);
...
vector<float> LBPImage (MultiArrayView<2, UInt8> const imin, MultiArrayView<2, UInt8> const immask, MultiArrayView<2, UInt8> imout, int const R, int const P, bool isInterplt){
